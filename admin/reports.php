        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mb-0">
                    ...
                    <?php echo $report_period ?> <span class="badge bg-light text-dark border ms-1"><?php echo $date_diff ?> days</span>
                </p>
            </div>
            <div class="btn-group">
                <a href="export_handler.php?type=csv&start_date=<?php echo $start_date ?>&end_date=<?php echo $end_date ?><?php echo $filter_service ? '&service_id=' . $filter_service : '' ?><?php echo $filter_employee ? '&employee_id=' . $filter_employee : '' ?><?php echo $filter_payment ? '&payment_method=' . $filter_payment : '' ?>"
                class="btn btn-outline-success">
                    <i class="fas fa-file-csv me-1"></i> Export CSV
                </a>
                <a href="export_handler.php?type=pdf&start_date=<?php echo $start_date ?>&end_date=<?php echo $end_date ?><?php echo $filter_service ? '&service_id=' . $filter_service : '' ?><?php echo $filter_employee ? '&employee_id=' . $filter_employee : '' ?><?php echo $filter_payment ? '&payment_method=' . $filter_payment : '' ?>"
                    ...
                    <div class="row g-3">
                        <div class="col-lg-3 col-md-6">
                            ...
                            <select class="form-select" id="date-range-select" name="date_range">
                                <option value="" <?php echo $date_range=='' ? 'selected' : '' ?>>Custom Range</option>
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <select class="form-select" id="payment_method" name="payment_method">
                                ...
                                <?php foreach ($payment_methods_list as $method): ?>
                                    <option value="<?php echo $method['payment_method'] ?>" <?php echo $filter_payment==$method['payment_method'] ? 'selected' : '' ?>>
        ...
        <div class="row">
            ...
            <div class="row mb-4">
                <div class="col-md-4">
                    <div class="card shadow-sm h-100">
                        ...
                        <div class="card-body p-0">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <span class="badge bg-primary rounded-pill"><?php echo $busiest_day['name'] ?? 'N/A' ?></span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <div>
                                    ...
                                    <span class="badge bg-success rounded-pill"><?php echo $busiest_time_slot['name'] ?? 'N/A' ?></span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <div>
                        ...
                        ?>
                                        <span class="badge bg-warning rounded-pill"><?php echo $top_employee ? $top_employee['name'] : 'N/A' ?></span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <div>
                        ...
                        ?>
                                        <span class="badge bg-info rounded-pill"><?php echo $top_service ? $top_service['name'] : 'N/A' ?></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h2 class="mb-0 text-primary">৳<?php echo number_format($summary['total_revenue'], 2) ?></h2>
                                <p class="text-muted small mb-0">
                                    <i class="fas fa-receipt me-1"></i> Avg. ৳
                                    <?php echo number_format($summary['avg_transaction'], 2) ?> per transaction
                                </p>
                            </div>
                        ...
                        <?php if ($date_range === 'month' || $date_range === 'last_month'): ?>
                            ...
                            ?>
                                    <div class="progress-bar bg-primary" role="progressbar" style="width:<?php echo $target_progress ?>%" aria-valuenow="<?php echo $target_progress ?>" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <p class="small text-muted mt-1 mb-0">
                                <?php echo $day_of_month ?> of
                                    <?php echo $days_in_month ?> days (
                                        <?php echo round($target_progress) ?>%)
                            </p>
                            <?php endif; ?>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h2 class="mb-0 text-success"><?php echo number_format($summary['total_appointments']) ?></h2>
                                <p class="text-muted small mb-0">
                                    <i class="fas fa-users me-1"></i>
                                    <?php echo number_format($summary['unique_customers']) ?> unique customers
                                </p>
                            </div>
                        ...
                        <div class="d-flex align-items-center small">
                            ...
                            <span class="badge                                                                                                                                                                                                                                                             <?php echo $retention_rate >= 50 ? 'bg-success' : ($retention_rate >= 30 ? 'bg-warning' : 'bg-danger') ?>">
                            <?php echo $retention_rate ?>%
                        </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h2 class="mb-0 text-warning"><?php echo number_format($summary['new_customers']) ?></h2>
                                <p class="text-muted small mb-0">
                        ...
                        <div class="d-flex align-items-center small">
                            ...
                            <?php echo number_format($summary['cancelled_appointments']) ?>
                        </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card shadow-sm border-info h-100">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h2 class="mb-0 text-info"><?php echo number_format($summary['online_payment_count']) ?></h2>
                                <p class="text-muted small mb-0">
                                    <i class="fas fa-credit-card me-1"></i> ৳
                                    <?php echo number_format($summary['online_payment_amount'], 2) ?> total
                                </p>
                            </div>
                    ...
                    ?>
                            <div class="progress mt-3" style="height: 5px;">
                                <div class="progress-bar bg-info" role="progressbar" style="width:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             <?php echo min(100, $online_percentage) ?>%"
                                aria-valuenow="<?php echo $online_percentage ?>" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <p class="small text-muted mt-1 mb-0">
                                <?php echo $online_percentage ?>% of total revenue
                            </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body  align-items-center p-3">
                        ...
                        <div style="flex: 1 1 300px; min-width: 300px;">
                                ...
                                <table class="table table-sm">
                                    ...
                                    ?>
                                            <?php while ($row = $day_of_week_analysis->fetch_assoc()): ?>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><span class="badge" style="background-color: <?php echo $color ?>"><?php echo $row['day_name'] ?></span></td>
                                                        <td class="text-center">
                                                            <?php echo number_format($row['appointment_count']) ?>
                                                        </td>
                            ...
                            <div class="alert alert-info mt-2 mb-0">
                                ...
                                <?php echo htmlspecialchars($busiest_day['name']) ?> with
                                    <?php echo number_format($busiest_day['count']) ?> services (৳
                                        <?php echo number_format($busiest_day['revenue'], 2) ?>)
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td>
                                                <a href="reports.php?start_date=<?php echo $start_date ?>&end_date=<?php echo $end_date ?>&service_id=<?php echo $row['id'] ?>">
                                                    <?php echo htmlspecialchars($row['name']) ?>
                                                </a>
                                                <div class="progress mt-1" style="height: 3px;">
                                                    <div class="progress-bar bg-primary" style="width:							                                                                                              						                                                                                              					                                                                                              				                                                                                              			                                                                                              		                                                                                               <?php echo $row['percentage'] ?>%"></div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <?php echo number_format($row['appointment_count']) ?>
                                            ...
                                            <td class="text-end">
                                                <?php echo number_format($row['percentage'], 1) ?>%</td>
                                        </tr>
                                        <?php endwhile; ?>
                                            <?php if ($total_service_count > 0): ?>
                                                <tr class="table-light fw-bold">
                                                    <td>Total</td>
                                                    <td class="text-center">
                                                        <?php echo number_format($total_service_count) ?>
                                                    </td>
                                                    <td class="text-end">৳
                                                        <?php echo number_format($total_service_revenue, 2) ?>
                                                    </td>
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td>
                                                <a href="reports.php?start_date=<?php echo $start_date ?>&end_date=<?php echo $end_date ?>&employee_id=<?php echo $row['id'] ?>">
                                                    <?php echo htmlspecialchars($row['name']) ?>
                                                </a>
                                                <div class="progress mt-1" style="height: 3px;">
                                            ...
                                            <td class="text-center							                                                          						                                                          					                                                          				                                                          			                                                          		                                                           <?php echo $rating_class ?>">
                                                <?php if ($rating != 'N/A'): ?>
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body p-3">
                        <table style="width: 100%;">
                            <tbody>
                                <tr>
                                    <td style="width: 40%; padding-right: 1rem; vertical-align: middle;">
                                    ...
                                    <td style="width: 60%; vertical-align: middle;">
                                        ...
                                        while ($row = $customer_frequency->fetch_assoc()) {
                                            ...
                                            if ($row['visit_count'] == 1) {$segments[0]['count'] += $row['customer_count'];
                                                $segments[0]['revenue'] += ($row['visit_count'] * $row['customer_count'] * ($summary['avg_transaction'] ?? 0));} else if ($row['visit_count'] >= 2 && $row['visit_count'] <= 3) {$segments[1]['count'] += $row['customer_count'];
                                                $segments[1]['revenue'] += ($row['visit_count'] * $row['customer_count'] * ($summary['avg_transaction'] ?? 0));} else if ($row['visit_count'] >= 4 && $row['visit_count'] <= 6) {$segments[2]['count'] += $row['customer_count'];
                                                $segments[2]['revenue'] += ($row['visit_count'] * $row['customer_count'] * ($summary['avg_transaction'] ?? 0));} else { $segments[3]['count'] += $row['customer_count'];
                                                $segments[3]['revenue'] += ($row['visit_count'] * $row['customer_count'] * ($summary['avg_transaction'] ?? 0));}
                                        }
                                        foreach ($segments as $segment):
                                            ...
                                            ?>
                                                        <tr>
                                                            <td>
                                                                <span class="badge me-1" style="background-color:														                                                                                             												                                                                                             										                                                                                             								                                                                                             						                                                                                             				                                                                                              <?php echo $segment['color'] ?>">&nbsp;</span>
                                                                <?php echo $segment['name'] ?>
                                                                    <div class="progress mt-1" style="height: 3px;">
                                                                        <div class="progress-bar" style="background-color:<?php echo $segment['color'] ?>; width:<?php echo $percentage ?>%"></div>
                                                                    </div>
                                                                    <span class="small text-muted"><?php echo $percentage ?>% of customers</span>
                                                            </td>
                                                            <td class="text-center">
                                                                <?php echo number_format($segment['count']) ?>
                                                            </td>
                                                            <td class="text-end">৳
                                                                <?php echo number_format($segment['revenue'], 2) ?>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                                                                    endif;
                            ...
                            if ($loyal_percentage > 20): ?>
                                                <p class="mb-0">Your loyal customers (
                                                    <?php echo $loyal_percentage ?>% of customer base) contribute approximately
                                                        <?php echo $loyal_revenue_percentage ?>% of your total revenue. Focus on retaining these valuable customers.</p>
...
?>
                                                    <tr>
                                                        <td>
                                                            <span class="badge me-1" style="background-color:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       <?php echo $color ?>">&nbsp;</span>
                                                    ...
                                                    <?php endwhile; ?>
                                                        <tr class="table-light fw-bold">
                                                            ...
                                                            <td class="text-end">৳
                                                                <?php echo number_format($total_payment_revenue, 2) ?>
                                                            </td>
                                                        </tr>
                                    </tbody>
                                </table>
...
?>
                            ...
                            <div class="alert alert-info mt-3 mb-0">
                                <h6 class="mb-2"><i class="fas fa-lightbulb me-2"></i>Insight</h6>
                                <p class="mb-0">Your busiest time slot is <strong><?php echo $busiest_time_slot['name'] ?></strong> with
                                    <?php echo number_format($busiest_time_slot['count']) ?> services completed. Consider scheduling your best staff during this time.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const customerSegmentChart = new Chart(ctxCustomerSegment, {
                    type: 'pie',
                    data: {
                        labels:                                                                                                                   <?php echo json_encode($segment_labels) ?>,
                        datasets: [{
                            data:                                                                                                                               <?php echo json_encode($segment_data) ?>,
                            backgroundColor:                                                                                                                                                                                                 <?php echo json_encode($segment_backgrounds) ?>,
                            ...
                            tooltip: {
                                callbacks: {
                                    label: function(context) {
                                        ...
                                        label += context.raw + ' (' + ((context.raw /                                                                                                                                                                                                                                                                                                                                                                                                                                                       <?php echo $total_customers ?>) * 100).toFixed(1) + '%)';
                                        return label;
                                    }
                                }
                            }
                ...
                const paymentMethodsChart = new Chart(ctxPaymentMethods, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            backgroundColor:                                                                                                                                                                                                 <?php echo json_encode($payment_method_backgrounds) ?>,
                            borderColor: 'rgba(255, 255, 255, 0.8)',
                            borderWidth: 2
                        }]
                    },
                ...
                const timeOfDayChart = new Chart(ctxTimeOfDay, {
                    type: 'bar',
                    data: {
                        labels:                                                                                                                   <?php echo json_encode($time_slot_labels) ?>,
                        datasets: [{
                            label: 'Revenue',
                            data:                                                                                                                               <?php echo json_encode($time_slot_data) ?>,
                            backgroundColor:                                                                                                                                                                                                 <?php echo json_encode($time_slot_backgrounds) ?>,
                            borderColor: 'rgba(255, 255, 255, 0.8)',
                            borderWidth: 2
                        }]
                    },
                ...
                const revenueComparisonChart = new Chart(ctxRevenueComparison, {
                    type: 'line',
                    data: {
                        labels:                                                                                                                   <?php echo json_encode($comparison_labels) ?>,
                        datasets:                                                                                                                               <?php echo json_encode($comparison_data) ?>
                    },
                    options: {
                        responsive: true,
                        maintainAspectRatio: false,
                ...
                const onlineOfflineChart = new Chart(ctxOnlineOffline, {
                    type: 'bar',
                    data: {
                        labels:                                                                                                                   <?php echo json_encode(array_column($online_offline_data->fetch_all(MYSQLI_ASSOC), 'type')) ?>,
                        datasets: [{
                            label: 'Revenue',
                            data:                                                                                                                               <?php echo json_encode(array_column($online_offline_data->fetch_all(MYSQLI_ASSOC), 'revenue')) ?>,
                ...
                const overallRevenueChart = new Chart(ctxOverallRevenue, {
                    type: 'pie',
                    data: {
                        labels:                                                                                                                   <?php echo json_encode(array_column($overall_revenue_data->fetch_all(MYSQLI_ASSOC), 'service_name')) ?>,
                        datasets: [{
                            data:                                                                                                                               <?php echo json_encode(array_column($overall_revenue_data->fetch_all(MYSQLI_ASSOC), 'total_revenue')) ?>,
                            backgroundColor:                                                                                                                                                                                                 <?php echo json_encode(array_column($overall_revenue_data->fetch_all(MYSQLI_ASSOC), 'color')) ?>,
                            borderColor: 'rgba(255, 255, 255, 0.8)',
                            borderWidth: 2
                        }]
                    },
